export const CONTENT = {
  ...
  resume: 'https://drive.google.com/file/d/1ziixt4UtF_GkDDsX1iM0T5Udsp6cfau2/view?usp=sharing',
  socials: [
    { label: 'github', url: 'https://github.com/nclan1', handle: '@nclan1' },
    { label: 'linkedin', url: 'https://www.linkedin.com/in/cnnolan/', handle: 'in/cnnolan' },
    { label: 'medium', url: 'https://medium.com/@nclan1', handle: '@nclan1' },
    { label: 'instagram', url: 'https://www.instagram.com/mr_lan1213/', handle: '@mr_lan1213' },
  ],
  about: {
  ...
  now: [
    ...
    { label: 'building', value: 'syllabi-sync', detail: 'a tool for students drowning in pdfs' },
    { label: 'learning', value: 'rust + systems', detail: 'cs455 + curiosity' },
    { label: 'listening', value: 'mostly jazz right now', detail: 'and a lot of frank ocean' },
  ],
  projects: [
    {
      year: '2025',
      ...
      description: 'turns a pile of course syllabi into one calendar, with assignments and exams pre-extracted.',
    ...
    },
    {
      ...
      description: 'a directory for news publications across u.s. states. helps researchers find local primary sources.',
    ...
    },
    {
      ...
      kind: 'chrome ext',
      stack: ['js', 'chrome api'],
      description: 'a tiny visual companion that keeps you honest about your distractions during focus sessions.',
    ...
    },
    {
      ...
      description: 'a place to share the lines that wrecked you from books you\'ve read.',
    ...
    },
    {
      ...
      kind: 'desktop',
      stack: ['python', 'tk'],
      description: 'reads guitar tabs and plays them so you can practice along.',
